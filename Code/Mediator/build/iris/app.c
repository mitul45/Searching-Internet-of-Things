...
extern void *memset(void *arg_0x2aaaab3d8020, int arg_0x2aaaab3d8288, size_t arg_0x2aaaab3d8530);
...
typedef int (*__compar_fn_t)(const void *arg_0x2aaaab3f7838, const void *arg_0x2aaaab3f7b10);
...
} __attribute__((packed)) AggregationMsg;
...
typedef TMilli MediatorC__Timer0__precision_tag;
...
static void MediatorC__Timer0__fired(void );
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static void MediatorC__AMControl__startDone(error_t error);
#line 117
static void MediatorC__AMControl__stopDone(error_t error);
# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
static void MediatorC__Boot__booted(void );
...
MediatorC__pushReceiver__receive(
#line 60
message_t * msg, 
void * payload, 
...
static void MediatorC__aggregationSender__sendDone(
#line 92
message_t * msg, 
...
error_t error);
#line 99
static void MediatorC__pullSender__sendDone(
#line 92
message_t * msg, 
...
MediatorC__pullReceiver__receive(
#line 60
message_t * msg, 
void * payload, 
...
MediatorC__aggregationReceiver__receive(
#line 60
message_t * msg, 
void * payload, 
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
static void /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 85
message_t * msg, 
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static void /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 85
message_t * msg, 
...
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void MediatorC__Timer0__startPeriodic(uint32_t dt);
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t MediatorC__AMControl__start(void );
...
uint8_t len);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t MediatorC__aggregationSender__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
#line 69
static error_t MediatorC__pullSender__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
static void MediatorC__Leds__led2Toggle(void );
# 77 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
static am_addr_t MediatorC__AMPacket__source(
#line 73
message_t * amsg);
# 21 "MediatorC.nc"
bool MediatorC__busy = FALSE;
message_t MediatorC__pkt;
#line 22
message_t MediatorC__ppkt;
#line 22
message_t MediatorC__apkt;
uint16_t MediatorC__counter = 0;
#line 23
uint16_t MediatorC__i = 0;
#line 23
uint16_t MediatorC__source;
#line 23
uint16_t MediatorC__j = 0;
uint16_t MediatorC__array[10] = { 0 };
PullMsg *MediatorC__rcvdmsg;

static inline void MediatorC__Boot__booted(void );




static inline void MediatorC__AMControl__startDone(error_t err);
#line 44
static inline void MediatorC__Timer0__fired(void );
#line 65
static inline void MediatorC__AMControl__stopDone(error_t err);


static inline void MediatorC__aggregationSender__sendDone(message_t *msg, error_t error);
...
static inline void MediatorC__pullSender__sendDone(message_t *msg, error_t error);
...
static inline message_t *MediatorC__pushReceiver__receive(message_t *msg, void *payload, uint8_t len);
...
static inline message_t *MediatorC__pullReceiver__receive(message_t *msg, void *payload, uint8_t len);
#line 117
static inline message_t *MediatorC__aggregationReceiver__receive(message_t *msg, void *payload, uint8_t len);
# 69 "/opt/tinyos-2.1.1/tos/chips/atm1281/timer/HplAtm128TimerCtrl8.nc"
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 56
message_t * msg, 
...
static void /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 147
message_t * amsg, 
...
static error_t /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 56
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
static void /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.1.1/tos/system/AMQueueEntryP.nc"
static inline error_t /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
# 35 "/opt/tinyos-2.1.1/tos/interfaces/GeneralIO.nc"
...
{
  if (error == SUCCESS) {
      MediatorC__busy = FALSE;
    }
}

# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  MediatorC__aggregationSender__sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  MediatorC__pullSender__sendDone(msg, error);
#line 99
}
#line 99
# 57 "/opt/tinyos-2.1.1/tos/system/AMQueueEntryP.nc"
...
#line 57
{
  /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x2aaaac33fe18, message_t * msg, error_t error){
#line 89
  switch (arg_0x2aaaac33fe18) {
#line 89
    case 0U:
#line 89
      /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    case 1U:
#line 89
      /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x2aaaac33fe18, msg, error);
#line 89
      break;
#line 89
    }
...
#line 56
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x2aaaac33d020, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = ActiveMessageLayerP__AMSend__send(arg_0x2aaaac33d020, addr, msg, len);
#line 69
...
# 59 "/opt/tinyos-2.1.1/tos/interfaces/SendNotifier.nc"
inline static void ActiveMessageLayerP__SendNotifier__aboutToSend(am_id_t arg_0x2aaaabb581a0, am_addr_t dest, message_t * msg){
#line 59
    ActiveMessageLayerP__SendNotifier__default__aboutToSend(arg_0x2aaaabb581a0, dest, msg);
#line 59
}
#line 59
...
# 43 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceRequested__requested(uint8_t arg_0x2aaaabc031a0){
#line 43
    /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceRequested__default__requested(arg_0x2aaaabc031a0);
#line 43
}
#line 43
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x2aaaabc026e0){
#line 49
    /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceConfigure__default__configure(arg_0x2aaaabc026e0);
#line 49
}
#line 49
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x2aaaabc031a0){
#line 51
    /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x2aaaabc031a0);
#line 51
}
#line 51
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x2aaaabc026e0){
#line 55
    /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x2aaaabc026e0);
#line 55
}
#line 55
# 48 "/opt/tinyos-2.1.1/tos/chips/rf2xx/util/Tasklet.nc"
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void Atm128SpiP__Resource__granted(uint8_t arg_0x2aaaac095020){
#line 92
  switch (arg_0x2aaaac095020) {
#line 92
    case 0U:
#line 92
...
#line 92
    default:
#line 92
      Atm128SpiP__Resource__default__granted(arg_0x2aaaac095020);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__Resource__granted(uint8_t arg_0x2aaaabc04020){
#line 92
  Atm128SpiP__ResourceArbiter__granted(arg_0x2aaaabc04020);
#line 92
}
#line 92
# 171 "/opt/tinyos-2.1.1/tos/system/SimpleArbiterP.nc"
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x2aaaabc026e0){
#line 49
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceConfigure__default__configure(arg_0x2aaaabc026e0);
#line 49
}
#line 49
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x2aaaabc026e0){
#line 55
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x2aaaabc026e0);
#line 55
}
#line 55
# 56 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__release(uint8_t arg_0x2aaaac0b46e0){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__Resource__release(arg_0x2aaaac0b46e0);
#line 110
...
# 48 "/opt/tinyos-2.1.1/tos/chips/rf2xx/util/RadioAlarm.nc"
inline static void RadioAlarmP__RadioAlarm__fired(uint8_t arg_0x2aaaabb03060){
#line 48
  switch (arg_0x2aaaabb03060) {
#line 48
    case 0U:
#line 48
...
#line 48
    default:
#line 48
      RadioAlarmP__RadioAlarm__default__fired(arg_0x2aaaabb03060);
#line 48
      break;
#line 48
    }
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool Atm128SpiP__ResourceArbiter__isOwner(uint8_t arg_0x2aaaac0b46e0){
#line 118
  unsigned char __nesc_result;
#line 118

#line 118
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__Resource__isOwner(arg_0x2aaaac0b46e0);
#line 118
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0x2aaaabc031a0){
#line 51
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceRequested__default__immediateRequested(arg_0x2aaaabc031a0);
#line 51
}
#line 51
# 84 "/opt/tinyos-2.1.1/tos/system/SimpleArbiterP.nc"
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__immediateRequest(uint8_t arg_0x2aaaac0b46e0){
#line 87
  unsigned char __nesc_result;
#line 87

#line 87
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__Resource__immediateRequest(arg_0x2aaaac0b46e0);
#line 87
...
# 43 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceRequested__requested(uint8_t arg_0x2aaaabc031a0){
#line 43
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__ResourceRequested__default__requested(arg_0x2aaaabc031a0);
#line 43
}
#line 43
# 71 "/opt/tinyos-2.1.1/tos/system/SimpleArbiterP.nc"
...
# 78 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__request(uint8_t arg_0x2aaaac0b46e0){
#line 78
  unsigned char __nesc_result;
#line 78

#line 78
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__1__Resource__request(arg_0x2aaaac0b46e0);
#line 78
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * ActiveMessageLayerP__Snoop__receive(am_id_t arg_0x2aaaabb59670, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = ActiveMessageLayerP__Snoop__default__receive(arg_0x2aaaabb59670, msg, payload, len);
#line 67
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t MediatorC__aggregationSender__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 69
...
#line 69
# 115 "/opt/tinyos-2.1.1/tos/interfaces/Packet.nc"
inline static void * MediatorC__Packet__getPayload(message_t * msg, uint8_t len){
#line 115
  void *__nesc_result;
#line 115
...
# 77 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static am_addr_t MediatorC__AMPacket__source(message_t * amsg){
#line 77
  unsigned short __nesc_result;
#line 77
...
static inline message_t *MediatorC__aggregationReceiver__receive(message_t *msg, void *payload, uint8_t len)
{
  MediatorC__source = MediatorC__AMPacket__source(msg);

  if (TOS_NODE_ID < MediatorC__source) 
    {
      AggregationMsg *amsg = (AggregationMsg *)MediatorC__Packet__getPayload(&MediatorC__apkt, sizeof(AggregationMsg ));
      AggregationMsg *rmsg = (AggregationMsg *)payload;

#line 125
      __nesc_hton_uint16(amsg->nodeid.nxdata, __nesc_ntoh_uint16(rmsg->nodeid.nxdata));
      __nesc_hton_uint16(amsg->size.nxdata, __nesc_ntoh_uint16(rmsg->size.nxdata));
      MediatorC__j = 0;
      while (MediatorC__j < __nesc_ntoh_uint16(rmsg->size.nxdata)) 
        {
          __nesc_hton_uint16(amsg->nodes[MediatorC__j].nxdata, __nesc_ntoh_uint16(rmsg->nodes[MediatorC__j].nxdata));
          MediatorC__j++;
        }
      if (!MediatorC__busy) 
        {
          if (MediatorC__aggregationSender__send(AM_BROADCAST_ADDR, &MediatorC__apkt, sizeof(AggregationMsg )) == SUCCESS) 
            {
              MediatorC__busy = TRUE;
            }
        }
    }
  return msg;
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
inline static void /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 47
{
  /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 7);
  return /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}

# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t MediatorC__pullSender__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*MediatorAppC.pullSender.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 69
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void MediatorC__Leds__led2Toggle(void ){
#line 89
...
{
  MediatorC__source = MediatorC__AMPacket__source(msg);
  if (MediatorC__source > 10) {
    MediatorC__Leds__led2Toggle();
    }
  MediatorC__rcvdmsg = (PullMsg *)payload;
  if ((__nesc_ntoh_uint16(MediatorC__rcvdmsg->flag.nxdata) && TOS_NODE_ID < MediatorC__source) || (! __nesc_ntoh_uint16(MediatorC__rcvdmsg->flag.nxdata) && TOS_NODE_ID > MediatorC__source)) 

    {
      PullMsg *pmsg = (PullMsg *)MediatorC__Packet__getPayload(&MediatorC__ppkt, sizeof(PullMsg ));

#line 102
      __nesc_hton_uint16(pmsg->requiredid.nxdata, __nesc_ntoh_uint16(MediatorC__rcvdmsg->requiredid.nxdata));
      __nesc_hton_uint16(pmsg->flag.nxdata, __nesc_ntoh_uint16(MediatorC__rcvdmsg->flag.nxdata));
      __nesc_hton_uint16(pmsg->mediatorid.nxdata, __nesc_ntoh_uint16(MediatorC__rcvdmsg->mediatorid.nxdata));
      if (!MediatorC__busy) 
        {
          if (MediatorC__pullSender__send(AM_BROADCAST_ADDR, &MediatorC__ppkt, sizeof(PullMsg )) == SUCCESS) 
            {
              MediatorC__busy = TRUE;
            }
        }
...
static inline message_t *MediatorC__pushReceiver__receive(message_t *msg, void *payload, uint8_t len)
{
  if (MediatorC__counter < 10) 
    {
      PushMsg *tagpkt = (PushMsg *)payload;

#line 87
      MediatorC__array[MediatorC__counter++] = __nesc_ntoh_uint16(tagpkt->nodeid.nxdata);
    }
  return msg;
}
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * ActiveMessageLayerP__Receive__receive(am_id_t arg_0x2aaaabb5ba90, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x2aaaabb5ba90) {
#line 67
    case 6:
#line 67
      __nesc_result = MediatorC__aggregationReceiver__receive(msg, payload, len);
#line 67
      break;
#line 67
    case 7:
#line 67
      __nesc_result = MediatorC__pullReceiver__receive(msg, payload, len);
#line 67
      break;
#line 67
    case 8:
#line 67
      __nesc_result = MediatorC__pushReceiver__receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = ActiveMessageLayerP__Receive__default__receive(arg_0x2aaaabb5ba90, msg, payload, len);
#line 67
      break;
#line 67
    }
...
#line 83
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
  ActiveMessageLayerP__AMPacket__setDestination(amsg, addr);
#line 92
}
#line 92
#line 151
inline static void /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
  ActiveMessageLayerP__AMPacket__setType(amsg, t);
#line 151
}
#line 151
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void ActiveMessageLayerP__AMSend__sendDone(am_id_t arg_0x2aaaabb5c900, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x2aaaabb5c900, msg, error);
#line 99
}
#line 99
...
#line 117
  MediatorC__AMControl__stopDone(error);
#line 117
}
#line 117
#line 83
inline static error_t MediatorC__AMControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void MediatorC__Timer0__startPeriodic(uint32_t dt){
#line 53
...
static inline void MediatorC__AMControl__startDone(error_t err)
{
  if (err == SUCCESS) 
    {
      MediatorC__Timer0__startPeriodic(TIMER_PERIOD_MILLI);
    }
  else 
    {
      MediatorC__AMControl__start();
    }
}
...
#line 92
  MediatorC__AMControl__startDone(error);
#line 92
}
#line 92
# 125 "/opt/tinyos-2.1.1/tos/chips/rf2xx/layers/MessageBufferLayerP.nc"
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__Resource__granted(uint8_t arg_0x2aaaabc04020){
#line 92
  switch (arg_0x2aaaabc04020) {
#line 92
    case 0U:
#line 92
...
#line 92
    default:
#line 92
      /*RF230RadioC.SendResourceC.Arbiter*/SimpleArbiterP__0__Resource__default__granted(arg_0x2aaaabc04020);
#line 92
      break;
#line 92
    }
...
static inline void MediatorC__Timer0__fired(void )
{
  if (!MediatorC__busy) 
    {
      AggregationMsg *mpkt = (AggregationMsg *)MediatorC__Packet__getPayload(&MediatorC__pkt, sizeof(AggregationMsg ));

#line 49
      __nesc_hton_uint16(mpkt->nodeid.nxdata, TOS_NODE_ID);
      __nesc_hton_uint16(mpkt->size.nxdata, MediatorC__counter);
      MediatorC__i = 0;
      while (MediatorC__i < MediatorC__counter) 
        {
          __nesc_hton_uint16(mpkt->nodes[MediatorC__i].nxdata, MediatorC__array[MediatorC__i]);
          MediatorC__i++;
        }
      MediatorC__counter = 0;
      if (MediatorC__aggregationSender__send(AM_BROADCAST_ADDR, &MediatorC__pkt, sizeof(AggregationMsg )) == SUCCESS) 
        {
          MediatorC__busy = TRUE;
        }
    }
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x2aaaab972228){
#line 72
  switch (arg_0x2aaaab972228) {
#line 72
    case 0U:
#line 72
      MediatorC__Timer0__fired();
#line 72
      break;
#line 72
    case 1U:
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x2aaaab972228);
#line 72
      break;
#line 72
    }
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2aaaab532220){
#line 64
  switch (arg_0x2aaaab532220) {
#line 64
...
#line 64
    default:
#line 64
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x2aaaab532220);
#line 64
      break;
#line 64
    }
...
#line 47
{
  /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 6);
  return /*MediatorAppC.aggregationSender.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}
